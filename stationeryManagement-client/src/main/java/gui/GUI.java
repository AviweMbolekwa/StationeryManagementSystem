...
public class GUI implements ActionListener, ItemListener{
    ...
    public GUI(){
        ...
        adminLogin.setBackground(new Color(235, 137, 73));
        ...
        userLogin.setBackground(new Color(235, 137, 73));
        userLogin.setForeground(Color.WHITE);
        userLogin.setBorderPainted(false);
        userLogin.setOpaque(true);
        
        //Adding background color
        loginTitlePanel.setBackground(new Color(50, 119, 168));
        loginBodyPanel.setBackground(new Color(50, 119, 168));
        loginButtonPanel.setBackground(new Color(235, 137, 73));
        ...
        productHeader = new JLabel("ADD STATIONERY", SwingConstants.CENTER);
        ...
        updateProductHeader = new JLabel("EDIT STATIONERY", SwingConstants.CENTER);
        ...
        adminTitlePanel.setBackground(new Color(50, 119, 168));
        adminBodyPanel.setBackground(new Color(50, 119, 168));
        adminProductPanel.setBackground(new Color(50, 119, 168));
        adminUserPanel.setBackground(new Color(50, 119, 168));
        adminProductUpdatePanel.setBackground(new Color(50, 119, 168));
        adminUserUpdatePanel.setBackground(new Color(50, 119, 168));
        displayPanelProduct.setBackground(new Color(50, 119, 168));
        displayPanelUser.setBackground(new Color(50, 119, 168));
        logoutPanel.setBackground(new Color(50, 119, 168));
        ...
        customerLName = new JLabel("Customer Last Name:", SwingConstants.CENTER);
        ...
        productAmount = new JLabel("Product Quantity:", SwingConstants.CENTER);
        ...
        userTitlePanel.setBackground(new Color(50, 119, 168));
        userCustomerPanel.setBackground(new Color(50, 119, 168));
        displayPanelCustomer.setBackground(new Color(50, 119, 168));
        userProductsScroll.setBackground(new Color(50, 119, 168));
        transactionScroll.setBackground(new Color(50, 119, 168));
        displayPanelTransaction.setBackground(new Color(50, 119, 168));
        userTransactionPanel.setBackground(new Color(50, 119, 168));
        customerTransaction.setBackground(new Color(50, 119, 168));
        customerTransactionDisplayPanel.setBackground(new Color(50, 119, 168));
        logoutPanelUser.setBackground(new Color(50, 119, 168));
        userSouthPanel.setBackground(new Color(50, 119, 168));
        salesReportPane.setBackground(new Color(50, 119, 168));
    }
                ...
                for (User var : array) {
                    if (var.getId().equals(value)){
                        if(var.isActive()){
                             ...
                             this.refreshAdmin();
                             JOptionPane.showMessageDialog(null, "Success, user account is disabled");
                        } else {
